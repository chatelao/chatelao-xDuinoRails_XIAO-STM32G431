...
# Disable modules in Makefile variables to ensure correct CFLAGS generation
MICROPY_PY_MACHINE_IDLE = 0
MICROPY_PY_MACHINE_PULSE = 0
MICROPY_PY_LWIP = 0
...
# Force defines via CFLAGS as a safety net
